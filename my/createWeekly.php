...
function saveDaily($diary, $content, $currentTime, $id) {
    ...
    if($id) {
        ...
        $sql = "insert into `diary_info` (`id`, `corp_id`, `content`, `uid`, `type`, `show_time`, `report_time`, `fill_time`) values(null, $corpId, '".$content."', $uid, 2, $currentTime, $reportTime, $fillTime)";
        $diary->db->query($sql);
