...
CREATE TABLE IF NOT EXISTS `diary_comment` (
  ...
  KEY `to_uid` (`to_uid`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='日记评论表' AUTO_INCREMENT=50 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='日志信息表' AUTO_INCREMENT=167 ;
...
(1, '{"hour":"4","minute":"5","way":["email","sms","mms","remind"]}', '{"w":"7","hour":"17","minute":"45","way":["email","sms","mms","remind"]}', '{"date":"18","hour":"19","minute":"50","way":["email","sms","mms","remind"]}');
